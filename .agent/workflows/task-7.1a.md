...
## Context
Create sample data for new organizations to explore the platform.
...
### 1. Create seed-demo-data edge function
...
## Verification
1. Deploy function
2. Call with an organization_id
3. Verify data created in all tables
4. Verify is_demo = true on all records

## On Completion
Update `activity.md` and mark task 7.1a as `[x]`
