  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        ...
        {/* Quick Actions - Only show in edit mode with phone number and when user has permissions */}
        {isEditMode && person?.phone_number && !readOnly && (
          <>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        placeholder="volunteer, small group, etc."
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
