...
export default function Settings() {
  ...
  const handleSaveOrganizationProfile = async () => {
    ...
    try {
      ...
      toast({
        title: 'Error',
        description: error instanceof Error ? error.message : 'Failed to save organization profile',
        variant: 'destructive'
      });
    } finally {
      setLoading(false);
                    ...
                    <DialogContent>
                      ...
                      <div className="space-y-4 py-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <p className="text-xs text-muted-foreground">
                            Admins have full access. Pastors can manage people, campaigns, and escalations. Members have view-only access.
                          </p>
                        </div>
                      </div>
                      <DialogFooter>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="p-4 border rounded-lg">
                  ...
                  <ul className="text-sm text-muted-foreground space-y-1">
                    ...
                    <li>Access data exports</li>
                  </ul>
                </div>
                <div className="p-4 border rounded-lg">
                  <Badge variant="secondary" className="mb-2">Pastor</Badge>
                  <ul className="text-sm text-muted-foreground space-y-1">
                    <li>Manage people directory</li>
                    <li>Create and manage campaigns</li>
                    <li>Manage calling scripts</li>
                    <li>Handle follow-ups and escalations</li>
                  </ul>
                </div>
                <div className="p-4 border rounded-lg">
                  ...
                  <ul className="text-sm text-muted-foreground space-y-1">
                    ...
                    <li>View campaigns and call history</li>
