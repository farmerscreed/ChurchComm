          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <Button
                ...
                disabled={!canManageCampaigns || loading || !smsMessage.trim() || (smsRecipientType === 'group' && !smsSelectedGroupId)}
                className="w-full"
                size="lg"
              >
                {loading ? (
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <Button
                  ...
                  disabled={!canManageCampaigns || loading || !callSelectedGroupId || !selectedScriptId}
                  className="w-full"
                  size="lg"
                >
                  {loading ? (
